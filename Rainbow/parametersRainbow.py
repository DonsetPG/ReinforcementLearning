...
parser.add_argument('--history_length', type=int, default=4, metavar='T', help='Number of consecutive states processed')
...
parser.add_argument('--noise', type=bool, default=True, help='Do we use noise or not')
...
parser.add_argument('--epsilon', type=float, default=1.0, metavar='ε', help='Epsilon for the greedy exploration')
parser.add_argument('--min_epsilon', type=float, default=0.05, metavar='m_ε', help='Minimum at the end of the exploration')
parser.add_argument('--epsilon_decay', type=float, default=1.0e-4, metavar='r_ε', help='Linear decay for epsilon in the greedy policy ')
